...
function c60000026.initial_effect(c)
    ...
    e1:SetCondition(c60000026.condition)
    e1:SetOperation(c60000026.operation)
    c:RegisterEffect(e1)
    
end

function c60000026.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c60000026.operation(e,tp,eg,ep,ev,re,r,rp)
    -- Annulla l'attacco
    local a=Duel.GetAttacker()
